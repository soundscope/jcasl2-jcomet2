...
public class JaComet2 implements Util {
    ...
    public static void execute(final File inputFile, final File outputFile, final String... args) {
        try {
            ...
            final JaComet2 comet2 = new JaComet2();
            comet2.out = out;
    ...
    public static void main(String[] args) {
        ...
        if (version) {
            System.out.println("JaCOMET2 version 1.2.1");
            ...
            System.out.println("Usage: " + JaComet2.class.getSimpleName() + " [options] input.com");
            System.out.println(options);
        } else {
            JaComet2 comet2 = new JaComet2();
