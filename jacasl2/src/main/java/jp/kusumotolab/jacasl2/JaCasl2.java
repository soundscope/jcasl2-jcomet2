...
public class JaCasl2 {
  ...
  public static void main(String[] args) {
    String usage = "Usage: " + JaCasl2.class.getSimpleName() + " [options] input.cas [output.com]";
    ...
    if (version) {
      System.out.println("JaCASL2 version 1.1.7");
